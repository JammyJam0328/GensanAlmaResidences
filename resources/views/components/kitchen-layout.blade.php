...
<body class="font-rubik antialiased">
    <div class="flex h-screen">
        <div class="sidebar top-0 z-10 fixed bottom-0 left-0   bg-gray-600 w-28">
            <img src="{{asset('images/dmorvielogo.png')}}" class="h-64 w-full opacity-10 absolute  bottom-10 object-cover" alt="">
            <div class="h-32 border-b w-full border-gray-400 grid place-content-center">
                <div class=" grid place-content-center">
                    <x-svg.logo class="h-9" />
                </div>
            </div>
            <div class="flex flex-col space-y-2 mt-10">
                <a href="{{route('kitchen.dashboard')}}" class="flex h-12 hover:fill-white">
                    <div class="flex-1 grid place-content-center {{Request::routeIs('kitchen.dashboard') ? 'fill-white' : 'fill-gray-400'}} hover:fill-white">
                ...
                <a href="{{route('kitchen.menu')}}" class="flex h-12">
                    <div class="flex-1 grid place-content-center {{Request::routeIs('kitchen.menu') ? 'fill-white' : 'fill-gray-400'}} hover:fill-white">
                ...
                <a href="{{route('kitchen.order')}}" class="flex h-12 ">
                    <div class="flex-1 grid place-content-center  {{Request::routeIs('kitchen.order') ? 'fill-white' : 'fill-gray-400'}} hover:fill-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-8 w-8">
                            <path fill="none" d="M0 0h24v24H0z" />
                            <path
                ...
                <a href="{{route('kitchen.settings')}}" class="flex h-12">
                    <div class="flex-1 grid place-content-center {{Request::routeIs('kitchen.settings') ? 'fill-white' : 'fill-gray-400'}} hover:fill-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-8 w-8">
                            <path fill="none" d="M0 0h24v24H0z" />
                            <path
