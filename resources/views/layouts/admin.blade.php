            ...
            <div class="flex flex-col flex-1 min-h-0 bg-white border-r-2 border-primary-400">
                <div class="flex flex-col flex-1 pb-4 overflow-y-auto">
                    ...
                    <nav class="flex-1 px-2 mt-5 space-y-1 bg-white">
                        <x-admin.nav-link activeColor="bg-primary-500"
                            route="{{ route('re-admin.dashboard') }}"
                            isActive="{{ request()->is('re/admin/dashboard*') }}"
                            label="Dashboard">
                            <x-slot:icon>
                        ...
                        <x-admin.nav-link activeColor="bg-primary-500"
                            route="{{ route('re-admin.manage-rates') }}"
                            isActive="{{ request()->is('re/admin/manage-rates*') }}"
                            label="Manage Rates">
                            <x-slot:icon>
                        ...
                        <x-admin.nav-link activeColor="bg-primary-500"
                            route="{{ route('re-admin.manage-rooms') }}"
                            isActive="{{ request()->is('re/admin/manage-rooms*') }}"
                            label="Manage Rooms">
                            <x-slot:icon>
                        ...
                        <x-admin.nav-link activeColor="bg-primary-500"
                            route="{{ route('re-admin.guests') }}"
                            isActive="{{ request()->is('re/admin/guests*') }}"
                            label="Guests">
                            <x-slot:icon>
                        ...
                        <x-admin.nav-link activeColor="bg-primary-500"
                            route="{{ route('re-admin.manage-users') }}"
                            isActive="{{ request()->is('re/admin/manage-users*') }}"
                            label="Manage Users">
                            <x-slot:icon>
