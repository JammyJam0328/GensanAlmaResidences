                ...
                <div class="flex flex-col flex-1 pb-4 overflow-y-auto">
                    ...
                    <nav class="flex-1 px-2 mt-5 space-y-1 bg-white">
                        <x-frontdesk.nav-link activeColor="bg-primary-500"
                            route="{{ route('re-frontdesk.dashboard') }}"
                            isActive="{{ request()->is('re/frontdesk/dashboard*') }}"
                            label="Dashboard">
                            <x-slot:icon>
                        ...
                        <x-frontdesk.nav-link activeColor="bg-primary-500"
                            route="{{ route('re-frontdesk.check-in') }}"
                            isActive="{{ request()->is('re/frontdesk/check-in*') }}"
                            label="Check In">
                            <x-slot:icon>
                        ...
                        <x-frontdesk.nav-link activeColor="bg-primary-500"
                            route="{{ route('re-frontdesk.check-out') }}"
                            isActive="{{ request()->is('re/frontdesk/check-out*') }}"
                            label="Check Out">
                            <x-slot:icon>
                        ...
                        <x-frontdesk.nav-link activeColor="bg-primary-500"
                            route="{{ route('re-frontdesk.room-monitoring') }}"
                            isActive="{{ request()->is('re/frontdesk/room-monitoring*') }}"
