...
<div x-show="scan" x-cloak class="relative z-10" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto p-4 sm:p-6 md:p-20">
      ...
      class="mx-auto max-w-2xl h-[35rem] transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black ring-opacity-5 transition-all">
       <div class="relative bg-blue-300 h-full">
       {{-- @dump($scanner) --}}
