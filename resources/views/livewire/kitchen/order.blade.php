    ...
    <div class="mt-10 grid grid-cols-7 gap-3">
        @foreach ($categories as $category)
            <button wire:click="$set('category_id',{{ $category->id }})"
                class="{{ $category_id == $category->id ? 'bg-green-500 text-white text-gra' : 'bg-gray-50 text-gray-500' }} hover:bg-green-500 h-12 hover:text-white shado grid place-content-center  rounded-lg p-1">
