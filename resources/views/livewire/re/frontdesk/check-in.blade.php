        ...
        <div>
            <template x-if="noteShow">
                <div x-cloak
                    x-show="noteShow"
                    x-transition
                    class="rounded-md bg-blue-50 p-4 mb-2 border border-blue-400">
                    <div class="flex">
            ...
            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                        <div
                            class="flex justify-between items-center space-x-2 px-2 py-3 bg-white border-b border-gray-200 sm:px-6">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <x-button wire:key="{{ $guest->id }}"
                                                wire:click="$emit('setGuest', '{{ $guest->id }}')"
                                                sm>
                                                VIEW
                                            </x-button>
                                        </td>
