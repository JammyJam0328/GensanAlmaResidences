                    ...
                    <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                        <h1>
                            ...
                            <span class="mt-1 block text-4xl tracking-tight  ">
                                <span class="block uppercase text-6xl font-black font-rubik text-gray-700">D'Morvie
                                    Suites</span>
                                <span class="block font-rubik text-xl font-bold text-blue-900">Your Cheaper and
